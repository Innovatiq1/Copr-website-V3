            ...
            <AnimatedSection direction="right">
              <TiltCard intensity={8} className="h-full">
                <div className="rounded-3xl overflow-hidden h-full relative"
                  ...
                  <div className="relative h-52 overflow-hidden" style={{ background: '#F5F3FF' }}>
                    <div className="absolute top-3 left-3 w-2 h-2 rounded-full bg-violet-500 opacity-70" />
              ...
              <AnimatedSection key={v.title} delay={i * 80}>
                <TiltCard intensity={12} className="h-full">
                  <div className="relative rounded-2xl text-center p-7 h-full overflow-hidden"
                    ...
                    <p className="text-gray-600 text-[15px] font-medium leading-relaxed">{v.desc}</p>
                  </div>
                </TiltCard>
              </AnimatedSection>
            ))}
            ...
            <AnimatedSection direction="right">
              <TiltCard intensity={6} className="relative">
                ...
                <div className="absolute -bottom-5 -left-5 rounded-2xl p-4"
                  ...
                  <p className="text-xs text-gray-600 font-medium mt-0.5">Years of Excellence</p>
                </div>
                <div className="absolute -top-5 -right-5 rounded-2xl p-4"
                  ...
                  <p className="text-xs text-gray-600 font-medium mt-0.5">Countries</p>
                </div>
              </TiltCard>
            </AnimatedSection>
          </div>
