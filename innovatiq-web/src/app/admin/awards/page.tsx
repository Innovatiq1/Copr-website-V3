    ...
    <div className="min-h-screen" style={{ background: '#07101E' }}>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">Manage company awards and recognitions</p>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan={4} className="px-5 py-10 text-center text-gray-500">No awards found</td>
                </tr>
              ) : (
                awards.map((award) => (
                  <tr
                  ...
                  >
                    <td className="px-5 py-4 text-gray-300 text-sm font-medium max-w-xs">
