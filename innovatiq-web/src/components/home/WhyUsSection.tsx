...
const checks = [
  { text: 'End-to-end digital transformation capabilities', clr: '#BE123C', Icon: Zap    },
  { text: 'Dedicated account management & 24/7 support',   clr: '#BE123C', Icon: Clock  },
  { text: 'Transparent pricing with no hidden costs',       clr: '#BE123C', Icon: Shield },
  { text: 'Proven track record with 200+ enterprise clients', clr: '#BE123C', Icon: Star },
];
  ...
  return (
    <section className="relative py-24 overflow-hidden"
      ...
      <div className="absolute top-0 left-0 w-[700px] h-[700px] pointer-events-none"
        style={{ background: 'radial-gradient(ellipse at top left, rgba(190,18,60,0.07) 0%, transparent 65%)', filter: 'blur(50px)' }} />
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Hexagons */}
        <svg className="absolute" style={{ top:'8%',    left:'42%',  animation:'why-float   12s ease-in-out infinite' }}                      width="52" height="52"><polygon points="26,2 48,14 48,38 26,50 4,38 4,14"   fill="rgba(190,18,60,0.05)"   stroke="rgba(190,18,60,0.22)"   strokeWidth="1.5"/></svg>
        ...
        <div className="absolute" style={{ top:'5%',  right:'8%',  width:22, height:22, border:'1.5px solid rgba(190,18,60,0.20)',   borderRadius:3, background:'rgba(190,18,60,0.04)',   animation:'why-spin 14s linear infinite reverse' }} />
        ...
        {/* Diamonds */}
        <div className="absolute" style={{ top:'10%',    left:'4%',   width:12, height:12, background:'rgba(190,18,60,0.28)',   transform:'rotate(45deg)', borderRadius:2, animation:'why-drift 8s  ease-in-out infinite' }} />
        ...
        <svg className="absolute" style={{ top:'40%', right:'10%', animation:'why-drift 10s ease-in-out infinite', animationDelay:'-3s' }} width="16" height="16">
          <line x1="8" y1="0" x2="8" y2="16" stroke="rgba(190,18,60,0.32)"   strokeWidth="2"/>
          <line x1="0" y1="8" x2="16" y2="8" stroke="rgba(190,18,60,0.32)"   strokeWidth="2"/>
        </svg>
              ...
              <div className="relative">
                ...
                <div className="rounded-3xl overflow-hidden h-[300px] sm:h-[400px] lg:h-[520px]">
                  ...
                  <div className="absolute top-0 right-0 w-52 h-52 pointer-events-none"
                    style={{ background: 'linear-gradient(135deg, rgba(190,18,60,0.22) 0%, transparent 70%)' }} />
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-[52px] font-bold text-gray-900 mb-5 leading-tight">
              ...
              <span className="block" style={{
                backgroundImage: 'linear-gradient(135deg, #9F1239 0%, #BE123C 40%, #E11D48 100%)',
